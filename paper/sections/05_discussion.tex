...
enough under high contamination that the case for joint
noise-and-imbalance-aware training remains strong. Telling these two
situations apart requires the kind of audit this study performs, not an
assumption that a published correction is safe by default.
