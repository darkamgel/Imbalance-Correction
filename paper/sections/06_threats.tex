...
The ten datasets audited range from 270 to 17{,}898 raw rows
...
which tops out at 2{,}622 rows even for HTRU2, the largest dataset,
because minority availability at $r{=}0.50$ is the binding constraint
regardless of how many majority rows the raw dataset has. Every condition
...
$N_{\text{common}}$ higher, is untested.
