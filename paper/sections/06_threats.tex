...
hash, Section~\ref{sec:methods-implementation}), using Apple's Metal
GPU backend. The whole study, XGBoost included, ran on one machine
...
to depend on any of them. Each stress
