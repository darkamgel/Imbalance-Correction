...
family and corruption direction. All four are significant at $p<10^{-11}$,
...
direction. All four are significant at $p<10^{-11}$.}
\label{tab:friedman}
\begin{tabular}{@{}llrr@{}}
\toprule
Family & Direction & $\chi^2$ & $n$ (blocks) \\
\midrule
XGBoost & Dir.\ A & 55.3  & 80 \\
XGBoost & Dir.\ B & 91.6  & 80 \\
TabPFN  & Dir.\ A & 64.3  & 60 \\
TabPFN  & Dir.\ B & 154.9 & 80 \\
\bottomrule
\end{tabular}
\end{table}
