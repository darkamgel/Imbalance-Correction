...
gap. Even using the true, uncorrected prior does not fully recover a
correction's clean-condition performance once contamination is severe.
This means the corrupted prior is not the main reason these corrections
decline at high contamination.
