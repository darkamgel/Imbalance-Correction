...
specifically for multi-class imbalanced data known to contain label noise, and
Khanal et al.~\cite{khanal2024activelabel} combine active learning with
...
training. Each of these lines of work proposes a new algorithm for the
