...
\label{eq:ncommon}
\end{equation}
For example, on Banknote Authentication with seed 13, the training pool has
$n_{\min}{=}488$ and $n_{\max}{=}609$; $\text{feasible\_n}(r)$ evaluates to
976.0, 761.2, 676.7, and 641.1 at $r{=}0.50, 0.20, 0.10, 0.05$ respectively,
so $N_{\text{common}} = \lfloor 641.1 \rfloor = 641$, and every one of the
four ratios for that dataset and seed draws exactly 641 training rows.
